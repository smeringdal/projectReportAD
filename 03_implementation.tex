...
\begin{figure}[htb]
    ...
    \end{subfigure}
    \caption{\todo[inline]{Få klarhet i hva slags enhet pore-volume er(om den har, men hvis ikke bør det vel være mellom 0 og 1?). Burde den ikke være motsatt? Plass til mindre olje jo høyere trykket er.}}
\end{figure}
