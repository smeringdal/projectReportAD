...
\textbf{Herfra og nedover har jeg ikke 100\% kontroll på om det jeg har skrevet er korrekt. Kan være lettest å få bekreftelse eventuelt rette opp på sintef.}
\begin{equation*}
    \frac{k}{\mu}(\nabla p - g\rho) + q = 0
