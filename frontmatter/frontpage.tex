...
\parskip = 1.0ex
\vspace*{1.5cm}
\textsc{\Large Master's Thesis in Mathematical Sciences}\\[0.5cm] % Major heading such as course name
...
\HRule \\[0.7cm]
{ \huge \bfseries Automatic Differentiation in Julia with Applications to Numerical Solution of PDEs}\\[0.4cm] % Title of your document
\HRule \\[1.5cm]
